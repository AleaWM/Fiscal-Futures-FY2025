...
```{r}
#| label: fig-figure1-top3-revenues
...
annotation <- data.frame(
  x = c(2013, 2018, 2013),
  y = c(16, 10, 5),  
  label = c("Individual Income Tax", "Federal Medicaid", "Sales Tax"# , "Corporate Income Tax",
            )
)
...
top3  +     geom_line(data = year_totals, aes(x=Year, y = Revenue/1000), lwd = 1)
