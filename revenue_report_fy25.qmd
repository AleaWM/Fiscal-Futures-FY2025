...
_**TO DO: Relabel image and 2004 pension spike**_
...
<!--- if for the IGPA datahub visualizations, combine smallest categories to "Other Departments". For the download data link, keep them separate. At least that is the current request as of March 14 2026   --->
...
#| tbl-cap: "Year totals with Fiscal Futures methodology for excluding/including revenue and expenditure objects."
#| tbl-cap-location: top
...
```{r}
#| label: tbl-datahub-export-revenues
#| tbl-cap: "Fiscal Futures Revenue Categories. As of March 2026, this is now the downloadable table on IGPA Datahub site. Totals are in millions of nominal dollars." 
...
```{r}
#| label: tbl-datahub-export-expenditures
#| tbl-cap: "Fiscal Futures Grouped Expenditure Categories. As of March 2026, this is now the downloadable table on IGPA Datahub site. Totals are in millions of nominal dollars. "
...
```{r}
#| label: fig-bargraphs-largest-expend-byfundingsource
#| fig-cap: "Largest Expenditures for FY2025"
...
Key funds: Healthcare Provider Relief (0793) and Hospital Provider (0346)
...
```{r exportexcelfile, warning = TRUE, message = TRUE}
